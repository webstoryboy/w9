<?php
    ...
    include_once $_SERVER['DOCUMENT_ROOT'].'/phptest/database/contents.php';
...
<body>
<?php
    include_once $_SERVER['DOCUMENT_ROOT'].'/phptest/include/header.php';
?>
    <div id="container">
        <div id="center">
            ...
            <div class="myButtonBox">
                <form name="photo" method="post" action="/phptest/database/myMember.php" enctype="multipart/form-data">
                    <div class="photoBox">
...
<?php
    include_once $_SERVER['DOCUMENT_ROOT'].'/phptest/include/footer.php';
?>
</body>
</html>