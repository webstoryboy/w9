...
<?php Context::addJsFile("modules/layout/ruleset/codeUpdate.xml", FALSE, "", 0, "body", TRUE, "") ?><form id="fo_layout"  action="./" method="post"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="codeUpdate" />
	...
	<textarea name="code_css" rows="8" cols="42" style="display:none;"><?php echo $__Context->layout_code_css ?></textarea>
	<section class="section">
		<h1>HTML<small> - layout.html</small></h1>
		<div style="margin-right:14px">
			<textarea name="code" rows="8" cols="42" style="width:100%; height:300px; font:12px 'DejaVu Sans Mono', monospace;"><?php echo $__Context->layout_code ?></textarea>
		</div>
		<div>
...
<?php Context::addJsFile("modules/layout/ruleset/codeUpdate.xml", FALSE, "", 0, "body", TRUE, "") ?><form id="fo_layout"  action="./" method="post"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="codeUpdate" />
	...
	<input type="hidden" name="layout_srl" value="<?php echo $__Context->layout_srl ?>" />
	<input type="hidden" name="act" value="procLayoutAdminCodeUpdate" />
	<textarea name="code" rows="8" cols="42" style="display:none;"><?php echo $__Context->layout_code ?></textarea>
	<section class="section">
		<h1>CSS<small> - layout.css</small></h1>
		<div style="margin-right:14px">
			<textarea name="code_css" rows="8" cols="42" style="width:100%; height:300px; font:12px 'DejaVu Sans Mono', monospace;"><?php echo $__Context->layout_code_css ?></textarea>
		</div>
	</section>
	<div class="x_clearfix btnArea">
		<span class="x_pull-left">
